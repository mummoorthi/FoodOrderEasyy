...
public class ChineaseFoodAdapter  extends RecyclerView.Adapter<ChineaseFoodAdapter.MyviewHolder> {

    Context activity;
    ArrayList<CommonModel> indianSpeclslist;
    CommonFoodPos pos;

    public ChineaseFoodAdapter(Activity activityy, ArrayList<CommonModel> list, CommonFoodPos foodpos) {
    ...
    @NonNull
    @Override
    public ChineaseFoodAdapter.MyviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.chinease_food_item, parent, false);
        return new ChineaseFoodAdapter.MyviewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ChineaseFoodAdapter.MyviewHolder holder, int position) {
